...
def main() -> None:
    args = parse_args(default_group="base")
    manifest_path = args.manifest or Path("skill/base/manifest.json")
    ...
    json_path, md_path = write_attack_result(results, args.report_dir, manifest, group="base")
